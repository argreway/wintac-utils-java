...
<div id="div-home">
    <div id="div-collapse">
        ...
        <div id="panel1" class="panel">
            <div id="p1content">
                <iframe name="scheduler-frame"
                        src="/jsp/scheduler.jsp"
                        style="border:solid 1px #777" width="100%" height="700" frameborder="0" scrolling="no"></iframe>
            </div>
        </div>

        <button id="btn-report" class="accordion">Reports</button>
        <div id="panel2" class="panel">
            <div id="p2content">
                <iframe name="reports-frame"
                        src="/jsp/reports.jsp"
                        style="border:solid 1px #777" width="100%" height="700" frameborder="0" scrolling="no"></iframe>
            </div>
        </div>
