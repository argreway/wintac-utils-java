 ...
 public class WOHistoryManager
 {
    ...
    {
       updateMonthlyWIPCount(InfluxClient.MEASUREMENT_HISTORY.WO_HISTORY.toString());
       updateMonthlyWIPCount(InfluxClient.MEASUREMENT_HISTORY.INV_HISTORY.toString());
    }

    public void updateMonthlyWIPCount(String measurement)
    {
       ...
       while (start.isBefore(terminate))
       {
          ...
          List<WO> result;
          if (measurement.equals(InfluxClient.MEASUREMENT_HISTORY.WO_HISTORY.toString()))
             result = DAOFactory.getWipDao().getWorkOrdersByTime(start.toDateTime(), end.toDateTime());
          else
             result = DAOFactory.getWipDao().getInvoicesByTime(start.toDateTime(), end.toDateTime());
       ...
       DAOFactory.getHistoryDao().writeWIPHistory(yearToMonthToCount, measurement);
    }
