 ...
 public class HistoryDao
 {
    ...
    public void writeWIPHistory(Map<String, Map<String, List<String>>> workOrderList, String measurement)
    {
       try
       {
          ...
          for (String year : workOrderList.keySet())
          {
             ...
             for (Map.Entry<String, List<String>> entry : monthCount.entrySet())
             {
                ...
                points.add(InfluxClient.createPoint(ts.getMillis(), measurement, tags, fields));
             }
          }
